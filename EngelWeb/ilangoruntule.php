...
<table border="1" width="1525" height="150" bgcolor="#00B5B5" bordercolor="aqua">
    ...
    <?php 
               $conn= mysqli_connect("localhost","root","","engelliweb");
                ...
                $verileriCek = mysqli_query ($conn,"select * from ilangonderi");
   ...
   ?>
          <center>
           <form action="sonuca.php" method="get">
...
<form>
    ...
    <input type="button" onclick="window.location.href = 'ilan.html'" value="PANEL" class="button">
    </center>
</form>
<style>
  .button {
